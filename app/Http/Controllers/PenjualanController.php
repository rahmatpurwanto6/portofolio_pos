...
class PenjualanController extends Controller
{
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('tanggal', function ($penjualan) {
                return tanggal_indo($penjualan->created_at, false);
            })
            ...
            ->addColumn('aksi', function ($penjualan) {
                return '
                    ...
                    <button onclick="showDetail(`' . route('penjualan.show', $penjualan->id) . '`)" class="btn btn-info"><i class="fa fa-eye"></i></button>
                    <button onclick="deleteData(`' . route('penjualan.destroy', $penjualan->id) . '`)" class="btn btn-danger"><i class="fa fa-trash"></i></button>
    ...
    public function notaKecil()
    {
        ...
        $detail = PenjualanDetail::with('produk')
            ->where('penjualan_id', session('id_penjualan'))
            ->get();
