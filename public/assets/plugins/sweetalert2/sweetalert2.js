...
(function (global, factory) {
    ...
    function handleModalClick(instance, domCache, dismissWith) {
        let isHandlingClick = false; // Tambahkan flag untuk mencegah rekursi

        domCache.container.onclick = function (e) {
            if (isHandlingClick) return; // Cegah rekursi jika sudah dalam proses handling
            ...
            try {
                ...
                console.error('Error in handleModalClick:', error);
            } finally {
                isHandlingClick = false; // Reset flag setelah selesai handling
            }
        };
    }
